                  ...
                  {isLoadingInitial ? (
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-[#FF7D67]/20 p-10 text-center">
                      <div className="w-16 h-16 bg-[#fff0eb] rounded-full flex items-center justify-center mx-auto mb-5">
                        <svg className="animate-spin h-8 w-8 text-[#FF6242]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                          <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                          <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                        </svg>
                      </div>
                      <h3 className="text-xl font-semibold text-gray-900 mb-3">Carregando grupos...</h3>
                      <p className="text-gray-600 max-w-xs mx-auto">Aguarde enquanto buscamos todos os grupos disponíveis para você.</p>
                    </div>
                  ) : searchResults.length > 0 ? (
                ...
                <div className="h-full rounded-2xl overflow-hidden shadow-xl border border-[#FF7D67]/30 bg-white/70 backdrop-blur-sm">
                  ...
                  <div className="absolute bottom-6 left-6 z-10 flex flex-col gap-3">
                    ...
                    <button
                      ...
                      className="p-3 rounded-full bg-white shadow-lg hover:shadow-xl transition-all text-[#FF6242] hover:bg-[#FF6242] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#FF6242]/50"
                    ...
                    <button
                      ...
                      className="p-3 rounded-full bg-white shadow-lg hover:shadow-xl transition-all text-gray-700 hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-gray-500/50"
